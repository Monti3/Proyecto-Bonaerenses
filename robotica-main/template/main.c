...
int main(void) 
{
    ...
    while(1)
    {
        ...
        const int motor1f = 9; const int motor1b = 10;
        const int motor2f= 27; const int motor2b = 28;
        ...
        f (gpio_get(7) == 1)
        {
            modo = 0; // se pone al robot en modo sumo robótico 
        }
        if(modo == 1)
        {
           ...
           if(infA = 0)   // si el sensor delanter0  se detecta fuera de la pista, se gira a la izquierda 
           {
